with open("pages/admin_dashboard.py", "r") as f:
    content = f.read()
...
if old_section in content:
    ...
    with open("pages/admin_dashboard.py", "w") as f:
        f.write(content)
    print("Patched admin_dashboard.py")
else:
    print("Could not find section in admin_dashboard.py")
