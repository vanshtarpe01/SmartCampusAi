...
with st.sidebar:
    ...
    for short_name in ["Dashboard", "AI Assistant", "Performance", "Study Planner", "Recommendations", "AI Knowledge", "About"]:
...
active_page_render = PAGES.get(nav_choice, render_dashboard)
active_page_render()
